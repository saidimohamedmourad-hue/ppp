<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Ajouter une école') }}</h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
            <form action="{{ route('school.store') }}" method="POST">
                ...
                <div class="mb-6 p-6 bg-gray-50 border border-gray-200 rounded-lg">
                    <h3 class="text-lg font-semibold mb-4 text-gray-800">Informations de l'école</h3>

                    <div class="mb-4">
                        <label for="name" class="block text-gray-700 font-semibold mb-2">Nom de l'école *</label>
                    ...
                    <div class="mb-4">
                        <label for="industry" class="block text-gray-700 font-semibold mb-2">Secteur *</label>
                ...
                <div class="mb-6 p-6 bg-gray-50 border border-gray-200 rounded-lg"
                    ...
                    <div x-show="mode === 'existing'" x-cloak>
                        <label for="owner_id" class="block text-gray-700 font-semibold mb-2">
                            Utilisateur school-owner sans école *
                        </label>
                        @if($unlinkedOwners->isEmpty())
                            <p class="text-orange-500 text-sm p-3 bg-orange-50 border border-orange-200 rounded-md">
                                Aucun utilisateur avec le rôle <strong>school-owner</strong> sans école associée n'est disponible.
                ...
                <div class="flex justify-end space-x-4">
                    <a href="{{ route('school.index') }}" class="text-gray-700 underline py-2">Annuler</a>
                    <button type="submit"
